...
class FeatureController extends Controller
{
    ...
    public function store(StoreFeatureRequest $request)
    {
        ...
        Feature::create($data);
        return to_route('admin.feature.index')->with('success' ,__('keywords.created_successfully'));
    }
    ...
    {
         $feature->delete();
        return to_route('admin.feature.index')->with('success' ,__('keywords.deleted_successfully'));
    }
}
